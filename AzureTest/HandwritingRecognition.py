...
subscription_key = 'a6da3d091e0f42a68e2a7cbfa84d2477'
...
image = open('./test_resized.jpg', 'rb').read()

# res = requests.post(url='http://httpbin.org/post',
#                     data=data,
#                     headers={'Content-Type': 'application/octet-stream'})
# The URL of a JPEG image containing handwritten text.
# body = {'url' : 'https://www.dropbox.com/s/w869ylrq6fqlqtx/800px-Cursive_Writing_on_Notebook_paper.jpg'}
...
try:
    ...
    response = requests.request('POST', uri_base + '/vision/v1.0/RecognizeText', data=image, headers=requestHeaders, params=params)
